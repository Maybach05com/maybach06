...
def load_data():
    try:
        ...
        st.error(f"Error loading data. Please ensure CSVs are correctly named and placed. Detail: {e}")
...
st.markdown("""
*An interactive, story-driven diagnosis of operations, customer experience, and actionable fixes.*
""")
